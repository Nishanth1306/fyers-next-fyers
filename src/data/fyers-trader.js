export const features = [
  {
    imageSrc: "https://assets.fyers.in/Marcom_Avatar/Images/trader-trade-directly-from-charts.webp",
    heading: "Trade directly from charts",
  },
  {
    imageSrc: "https://assets.fyers.in/Marcom_Avatar/Images/trader-price-ladder-trading.webp",
    heading: "Price ladder trading",
  },
  {
    imageSrc: "https://assets.fyers.in/Marcom_Avatar/Images/trader-historical-data-of-25-years.webp",
    heading: "Historical price data of 25+ years",
  },
];

export const stats = [
  { value: "1M+", label: "Traders love it!" },
...
export const products = [
  {
    ...
    description: "Drag & drop to place, modify and cancel orders from the charts.",
  },
  {
    title: "Price Ladder Trading",
    description: "Visualize price action & trade by observing bid/offers on this real-time ticker.",
  },
  {
    title: "Advanced Chart",
    description: "The most advanced charts & tools.",
  },
  {
    title: "24+ Years of EOD Data",
    description: "Historical EOD data of 24+ years and 4+ years of intraday charts.",
  },
  {
    title: "100+ Chart Indicators",
    description: "We have over 100 chart indicators including the CRP indicator on TradingView.",
  },
  {
    title: "Drawing Tools",
    description: "There are more than a dozen unique drawing tools.",
  },
  {
    title: "Corporate Actions & More",
    description: "Track corporate actions, dividends, bonuses, and splits.",
  },
];
