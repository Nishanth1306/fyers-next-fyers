export const features = [
  {
    imageSrc: "https://assets.fyers.in/Marcom_Avatar/Images/ipo-early-entry-advantage.webp",
    heading: "Early entry advantage",
    description:
      "IPOs give investors the chance to get in at the ground floor of a company before it lists publicly, potentially capturing future growth early.",
  },
  {
    imageSrc: "https://assets.fyers.in/Marcom_Avatar/Images/ipo-growth-potential.webp",
    heading: "Growth potential",
    description:
      "Many IPOs are from companies in expansion mode. If the business scales, early investors may benefit significantly.",
  },
  {
    imageSrc: "https://assets.fyers.in/Marcom_Avatar/Images/ipo-access-to-global-markets.webp",
    heading: "Invest in SMEs",
    description: "Unlock high growth opportunities in emerging small and medium sized businesses.",
  },
  {
    imageSrc: "https://assets.fyers.in/Marcom_Avatar/Images/ipo-portfolio-diversification.webp",
    heading: "Portfolio diversification",
    description: "IPOs allow you to add new businesses, sectors or innovative companies to your portfolio.",
  },
];

export const extraFeatures = {
  mobileImageHeight: "min-h-[390px]",
  features: [
    {
