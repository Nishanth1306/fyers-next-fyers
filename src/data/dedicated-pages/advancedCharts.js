...
export const features1 = {
  ...
  features: [
    ...
    //   featureDescription: "Real-time market analysis with the power of AI.",
    // },
  ],
};
...
export const features2 = [
  {
    ...
    iconAlt: "icon",
    title: "Smart Tools",
    description: "Draw, annotate and save your analysis across devices.",
  },
  {
    iconSrc: Feature2,
    iconAlt: "icon",
    title: "Trade Integration",
    description: "Place, modify and exit directly from charts.",
  },
];
