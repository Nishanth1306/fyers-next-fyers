...
import WomenImg from "/public/images/about-us/women.png";
    ...
    <>
      ...
      <main className="w-full overflow-y-hidden overflow-x-hidden bg-[#F2F4FB]">
        ...
        <AboutHighlightSection
          ...
          dynamicGrid="px-4 md:px-20  grid grid-cols-1 md:grid-cols-[2.4fr_1.6fr] items-center"
