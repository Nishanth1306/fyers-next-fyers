    ...
    <>
      ...
      <main>
        <PageIntro
          ...
          mobileImageSrc={
            "https://assets.fyers.in/Marcom_Avatar/Images/fyers-webapp-mobile-bg.webp"
          }
          ...
          buttons={[
            ...
            },
            {
              text: "Sign Up",
              className:
                "bg-[#182BFF] text-[#F2F4FB] py-[6px] px-[10px] md:p-[12px] cursor-pointer",
        ...
        <AboutHighlightSection
          ...
          aboutDesc={`No more switching platforms, no more missing tools.<br/> FYERS brings advanced trading features and seamless investing journeys together in one integrated experience.`}
