    ...
    <>
      ...
      <main className="font-plus-jakarta">
        ...
        <section className="py-[40px] md:py-[64px] flex flex-col gap-[12px] md:gap-[28px]">
          <h3 className="px-5 md:px-20 font-plus-jakarta font-semibold text-[#131319] text-[24px] md:text-[48px] leading-[32px] md:leading-[56px] -tracking-[0.1px] md:-tracking-[0.64px]">
            For the trader
          </h3>
