    ...
    <>
      ...
      <main>
        ...
        <section className="flex flex-col gap-[20px] md:gap-[24px] pt-[24px] md:pt-[64px]">
          <div className="custom-container 2xl:w-full px-4 md:px-10 lg:px-20">
        ...
        <div className="flex flex-col gap-[24px] md:gap-[28px] py-[40px] md:py-[64px]">
          <div className="custom-container 2xl:w-full px-4 md:px-10 lg:px-20  flex flex-col gap-[8px] md:gap-[12px]">
