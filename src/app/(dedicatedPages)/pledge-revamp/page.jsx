    ...
    <>
      ...
      <main>
        ...
        <AboutHighlightSection
          ...
          aboutTitleClassName="font-semibold font-plus-jakarta text-[24px] leading-[32px] md:text-[64px] lg:text-[40px] md:leading-[72px] text-[#F0F0FA] -tracking-[-0.1px] md:-tracking-[0.8px]"
