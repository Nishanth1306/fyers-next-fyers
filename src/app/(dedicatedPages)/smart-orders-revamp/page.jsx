    ...
    <>
      ...
      <main>
        ...
        <AboutHighlightSection
          ...
          aboutTitleClassName="font-semibold font-plus-jakarta text-[24px] leading-[32px] md:text-[48px] lg:text-[64px] md:leading-[52px] lg:leading-[72px] text-[#F0F0FA] -tracking-[-0.1px] md:-tracking-[0.8px]"
        ...
        <div className="flex flex-col gap-[24px] md:gap-[28px] pt-[40px] md:pt-[52px] lg:pt-[64px]">
