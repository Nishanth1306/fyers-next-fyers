...
export default function CardSection() {
  return (
    <div className="w-full flex flex-col gap-[32px] py-[24px] md:py-12 lg:py-16">
      {/* Main Heading */}
      <div className="px-4 md:px-10 lg:px-20 custom-container 2xl:w-full flex flex-col gap-[12px] md:gap-[32px]">
        ...
        <p className="font-manrope font-normal text-[#020202] text-[18px] leading-[26px] tracking-[0px] max-w-full">
          With a lightning-fast Scalper Terminal, Advanced Options Chain and Trade from Charts, up your options trading
          game.
        </p>
      </div>
      ...
      <div>
        ...
        <section className="flex flex-col gap-[24px] md:gap-[32px]">
          <h3 className="px-4 md:px-10 lg:px-20 custom-container 2xl:w-full font-plus-jakarta font-semibold text-[#131319] text-[24px] md:text-[48px] leading-10 md:leading-[56px] -tracking-[0.35px] md:-tracking-[0.64px]">
