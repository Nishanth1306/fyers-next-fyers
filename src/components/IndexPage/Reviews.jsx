    ...
    <div className="fy-hreviews-wrapper pt-6 md:pt-18 md:px-0">
      ...
      <div className="w-full pt-[24px] md:pt-[72px]">
        <div className="border-t border-b border-[#C8C8CC]">
          <div
            className="grid grid-cols-1 px-[16px] md:px-[0] custom-container [&>div:last-child]:border-b-0
 md:grid-cols-2 single-row"
          >
            {reviews.map((review, idx) => (
              ...
              >
                <div className="flex flex-col">
                  ...
                  <p className="text-[#182BFF] text-[16px] font-semibold leading-[28px] mt-[8px]">{review.name}</p>
