...
const Certificates = () => {
  return (
    <div className="fy-certificates">
      <div className="mb-6 md:mb-18 border-b border-[#C8C8CC]">
        <div className="fy-certificate-wrapper  px-4 md:px-[40px] lg:px-18 custom-container flex flex-wrap lg:flex-nowrap">
