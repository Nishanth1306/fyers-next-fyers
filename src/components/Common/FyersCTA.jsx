...
export default function FyersCTA() {
  return (
    <div className="bg-[#131319] py-[24px] border-b border-[#979798]">
      <div className="px-4 md:px-10 lg:px-20 flex flex-col md:flex-row md:items-center md:justify-between gap-[24px]">
        {/* Text Block */}
      ...
      <div className="flex gap-4 mt-6 md:mt-0 md:self-end md:justify-end px-4 md:px-10 lg:px-20">
        <Link
